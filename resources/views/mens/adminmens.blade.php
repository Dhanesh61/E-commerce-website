            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="{{route('mens.create')}}" class="btn btn-dark product-btn">New Product</a>
                    </div>
                    ...
                    <form  method="POST">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        <th style="width:20%">Men Product name</th>
                                        <th style="width:20%">men Description</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>${{$men->price}}</td>
                                        <td>
                                            <img src="{{ asset('img') }}/{{ $men->image }}" class="rounded-circle" width="50" height="50" alt="Product Image">
                                        </td>
                                        <td>
                                            <div style="display: flex;">
                                                <a href="{{ route('mens.edit', $men->id) }}" class="btn btn-sm custom-edit-button">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <form action="{{ route('mens.delete', $men->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
