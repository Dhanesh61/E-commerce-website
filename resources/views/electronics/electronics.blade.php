...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-700 dark:text-gray-200">
    ...
    <div class="image-carousel">
        <div class="image">
          <img src="../../dist/img/tvoffer.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="image">
          <img src="../../dist/img/freezeoffer.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        </div>
    ...
    <div class="row">
        @foreach($electronicss as $electronics)
        <div class="col-xs-18 col-sm-6 col-md-4" style="margin-top:10px;">
            <div class="img_thumbnail productlist">
                <img src="{{ asset('img/' . $electronics->image) }}" alt="electronics" class="img-fluid" style="width: 300px; height: 200px;">
                <div class="caption">
                    <h4>{{ $electronics->name }}</h4>
                    <p>{{ $electronics->description }}</p>
                    <p><strong>Price: </strong><del>{{ number_format($electronics->price * 1.10 ) }}</del> ${{ $electronics->price }}</p>
                    <p class="btn-holder"><a href="{{ route('add_to_cart', $electronics->id) }}" class="btn btn-primary btn-block text-center" role="button">Add to cart</a> </p>
                </div>
            </div>
        </div>
        @endforeach
