...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-700 dark:text-gray-200">
    ...
    <h1 id="shop-title" class="text-4xl font-bold text-center my-8">DK Brothers Shop</h1>
    <div class="image-carousel">
        ...
        <div class="header-container">
          ...
          <a href="{{ route('mens')}}">
          <div class="hader">
            <img src="../../dist/img/man.jpg" class="rounded-circle" alt="Mobile Image" style="width: 100px; height: 100px;">
          <h3>Men's Ware</h3>
          </div></a>
          <div class="hader">
